...
Route::post('addToCart', 'OrderController@addToCart')->middleware('auth:api');
Route::post('removeFromCart', 'OrderController@removeFromCart')->middleware('auth:api');
Route::get('viewCart', 'OrderController@viewCart')->middleware('auth:api');
Route::post('checkout', 'OrderController@checkout')->middleware('auth:api');
