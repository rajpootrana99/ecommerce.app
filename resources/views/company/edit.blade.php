                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input class="form-control" type="text" value="{{ $company->company_name }}" name="company_name" id="validatedCustomFile" placeholder="Company Name">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input class="form-control" type="text" value="{{ $company->company_phone }}" name="company_phone" id="validatedCustomFile" placeholder="Phone Number">
